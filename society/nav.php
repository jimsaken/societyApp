  ...
  <div class="container-fluid" style="background-color: #0082e6; font-family: montserrat">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      if($loggedin){
          ...
          <a class="nav-link" href="add_event.php" style="color: white">Add Events</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="event_list.php" style="color: white">Event List</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="members.php" style="color: white">Society Members</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="profile.php" style="color: white">Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="edit_profile.php" style="color: white">Edit Profile</a>
        </li> 
        <li class="nav-item">
